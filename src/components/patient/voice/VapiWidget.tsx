    ...
    <div className="max-w-5xl mx-auto px-4 flex flex-col overflow-hidden pb-20">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground mt-2">
          Have a voice conversation with our AI assistant for healthcare advice and guidance
        </p>
      </div>
          ...
          <div className="space-y-3">
            ...
            {callEnded && (
              <div className="message-item animate-in fade-in duration-300">
                ...
                <p className="text-foreground">Call ended. Thank you for using Medibook!</p>
              </div>
            )}
          </div>
        </div>
